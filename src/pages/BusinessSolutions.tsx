...
import { Monitor, Globe, ShoppingCart, FileCheck, CheckCircle } from 'lucide-react';
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="font-display text-4xl sm:text-5xl mt-4 mb-6">Digital and compliance support in one division.</h1>
              <p className="text-lg text-white/80 leading-relaxed">
                ICT services, web development, e-commerce solutions, and full compliance support to keep your business
                registered, operational, and digitally enabled.
              </p>
            </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="rounded-3xl bg-[var(--ink)] text-white p-10 text-center">
          <h2 className="font-display text-3xl mb-4">Ready to modernize your operations?</h2>
          <p className="text-white/70 max-w-2xl mx-auto mb-6">
            Let us handle your digital and compliance needs while you focus on growth.
          </p>
          <Link
            to="/contact"
